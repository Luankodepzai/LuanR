...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>LuanR chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "LuanR", HidePremium = false, IntroText = "LuanR⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("LuanR SCRIPT")
W:AddLabel("DiscordLuanR")
local Section = W:AddSection({
    Name = "Status"
})
